...
export default function Footer() {
  return (
    <footer className="relative border-t border-fg/[0.07]">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-5 py-14 md:flex-row md:justify-between md:px-8">
        <div className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-xl border border-fg/10 border-b-[3px] bg-gradient-to-b from-panel3 to-panel2 font-mono text-[11px] font-bold tracking-wider text-acid">
            QK
          </span>
          <div>
        ...
        <p className="max-w-md text-center font-mono text-[10.5px] leading-relaxed text-mist2 md:text-left">
